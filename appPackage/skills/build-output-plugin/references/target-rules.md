...
Rules snapshot: 2026-09-11. Canonical target: M365 Unified App Manifest v1.28.
The compatible-source target is separately labeled and may be used first
for the bounded personal upload/conversion route when legal metadata is
missing. It does not prove direct canonical v1.28 acceptance.
...
referenced actual tool JSON travels in the archive. The compatible-source
export intentionally rejects declared remote connectors because this subset
does not promise lossless conversion of their auth/descriptors. Use canonical
packaging with real metadata or reuse a verified existing native connection;
do not drop bindings or invent conversion fields.
...
Canonical output has a root manifest, generated 192x192 color and 32x32
...
Compatible-source output has the Claude-compatible dot-directory manifest
and skills; it is a Draft source export, not a canonical archive.
